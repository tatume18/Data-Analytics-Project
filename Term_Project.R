...
Gender<- factor(Survey_Analysis$qGENDER)
table(Survey_Analysis$qGENDER)
Gender<- factor(Survey_Analysis$qGENDER,labels = c("1","2"))
Survey_Analysis<- cbind.data.frame(Survey_Analysis,Gender)
